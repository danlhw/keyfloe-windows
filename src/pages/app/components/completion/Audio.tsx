...
export const Audio = ({
  ...
  const { selectedSttProvider, keyfloeApiEnabled, selectedAudioDevices } =
    useApp();
  ...
  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {(keyfloeApiEnabled || speechProviderStatus) && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        ...
        side="bottom"
        className={`w-80 p-3 ${
          keyfloeApiEnabled || speechProviderStatus ? "hidden" : ""
        }`}
        sideOffset={8}
      >
