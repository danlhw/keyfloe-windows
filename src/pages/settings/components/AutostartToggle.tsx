  ...
  return (
    <div id="autostart" className={`space-y-2 ${className}`}>
      <Header
        ...
        description="Automatically open Keyfloe when your system starts"
        isMainTitle
      />
        ...
        <div className="flex items-center space-x-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {isEnabled
                ? "Keyfloe will launch automatically on system startup"
                : "Keyfloe will not launch automatically"}
            </p>
          </div>
        </div>
        <Switch
